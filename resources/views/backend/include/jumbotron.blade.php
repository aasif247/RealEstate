<div class="jumbotron-1">
    <div class="jumbotron jumbotron-fluid">
        <div class="container-fluid">
            <button class="btn btn-rounded btn-secondary btn-outline">Message</button>
            <button class="btn btn-rounded btn-secondary btn-outline">Follow</button>
            <h1 class="display-3">{{ $page_title }}
            ...
            <button type="button" class="btn btn-raised btn-primary bmd-btn-fab" data-toggle="dropdown">
