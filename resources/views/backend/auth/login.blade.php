...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/backend/../cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css" />
    <link rel="stylesheet" type="text/css" href="asset/backend/../cdnjs.cloudflare.com/ajax/libs/flag-icon-css/1.0.0/css/flag-icon.min.css" />
    <link rel="stylesheet" type="text/css" href="asset/backend/../cdnjs.cloudflare.com/ajax/libs/weather-icons/2.0.9/css/weather-icons.min.css" />
    <link rel="stylesheet" type="text/css" href="asset/backend/../cdnjs.cloudflare.com/ajax/libs/weather-icons/2.0.9/css/weather-icons-wind.min.css" />
    ...
    <link rel="stylesheet" type="text/css" href="asset/backend/bower_components/nouislider/distribute/nouislider.min.css" />
    <link rel="stylesheet" type="text/css" href="asset/backend/bower_components/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css" />
...
<body id="pages-sign-in" data-layout="empty-view-1" data-controller="pages" data-view="sign-in">
    ...
    <script src="../../scripts/tables/sortable.js"></script>
    <script src="../../scripts/dashboards/geographic.js"></script>
    <script src="../../scripts/dashboards/analytics.js"></script>
    <script src="../../scripts/pages/empty.js"></script>
    <script src="../../scripts/pages/coming-soon.js"></script>
    ...
    <script src="../../scripts/extras/markdown.js"></script>
    <script src="../../scripts/extras/code.js"></script>
    <script src="../../scripts/forms/file-uploads.js"></script>
    <script src="../../scripts/forms/date-picker.js"></script>
    <script src="../../scripts/elements/steps-1.js"></script>
    <script src="../../scripts/forms/validation.js"></script>
    <script src="../../scripts/forms/sliders.js"></script>
